...
```{r metrictable, fig.cap = cap("Performance Metrics")}
pander::pander(
...
```{r, fig.cap =cap( "Figure :A standard decision tree")}
...
```{r, fig.cap = cap("A small, short tree")}
...
```{r, fig.cap = cap("A moderately large tree")}
