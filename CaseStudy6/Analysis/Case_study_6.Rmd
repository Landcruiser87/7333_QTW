...
data.frame(t(get_metrics(rp_predict1)))
...
data.frame(t(get_metrics(rp_predict2)))
...
data.frame(t(get_metrics(rp_predict3)))
...
data.frame(t(get_metrics(rp_predict4)))
