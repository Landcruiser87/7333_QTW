...
data.frame(router = c("router a","router b", "both"), `online rmse` = c(err_cv1, err_cv2, err_cv3))
```
...
```{r}
data.frame(router = c("router a","router b", "both", "weighted"), `online rmse` = c(err_cv1, err_cv2, err_cv3, err_cv4))
```
