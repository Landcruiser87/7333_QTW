...
reshapeSS7 = function(data, varSignal = "signal", 
                     keepVars = c("posXY", "posX","posY"),
                     sampleAngle = FALSE, 
                     refs = seq(0, 315, by = 45)) {
  byLocation =
...
onlineCVSummary = reshapeSS7(offline, keepVars = keepVars, sampleAngle = TRUE)
...
selectTrain2 = function(angleNewObs, signals = NULL, m = 1){
  ...
  offlineSubset = signals[ signals$angle %in% angles, ]
  reshapeSS7(offlineSubset, varSignal = "avgSignal")
}
