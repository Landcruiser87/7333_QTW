...
```
#> /nix/store/xr8iazfxdgpby1cdd70g39qw6s76sz3h-python3.7-pandas-0.25.1/lib/python3.7/site-packages/pandas/plotting/_matplotlib/tools.py:188: RuntimeWarning: More than 20 figures have been opened. Figures created through the pyplot interface (`matplotlib.pyplot.figure`) are retained until explicitly closed and may consume too much memory. (To control this warning, see the rcParam `figure.max_open_warning`).
...
<img src="Cs10_files/figure-html/unnamed-chunk-17-1.svg" style="display: block; margin: auto;" />
...
<img src="Cs10_files/figure-html/unnamed-chunk-18-1.svg" style="display: block; margin: auto;" />
