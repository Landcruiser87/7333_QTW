...
```{r, fig.cap = "**Figure 1: Mens Age Boxplots from 1999-2012**: *Mens median age looks to be decreasing over time.*"}
...
```{r, fig.cap = "**Figure 2: Womens Age Boxplots from 1999-2012**: *Women's age remains consistent over course of the 13 years.*"}
...
```{r, fig.cap = "**Figure 3:M/W Speed Density**: *It appears the women of the cherry blossom race are slightly slower than the men*"}
...
```{r, fig.cap = "**Figure 4: M/W Age Density**: *It appears they have the same age*"}
all %>% ggplot() +
...
```{r, fig.cap = "**Figure 5: M/W Avg Speed by Year**: Speed for each sex over the years"}
...
```{r, fig.cap = "**Figure 6**: Attendance has been rising at the Blossom run!"}
