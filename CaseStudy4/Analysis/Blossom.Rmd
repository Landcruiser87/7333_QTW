...
```{r, fig.cap = "**CAPTION**: *It appears the women of the cherry blossom race are slightly slower than the men*"}
...
```{r, fig.cap = "**CAPTION**: *It appears they have the same age*"}
all %>% ggplot() +
...
```{r, fig.cap = "**CAPTION**: Speed for each sex over the years"}
...
```{r, fig.cap = "**CAPTION**: Attendance has been rising at the Blossom run!"}
